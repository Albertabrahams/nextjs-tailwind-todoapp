  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row justify-center mt-5">
        ...
        <button className=" inline bg-[#21A7F9] align-bottom max-h-9 mx-3 px-3 rounded  "  type="button" ><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6"  viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          <div>          
            <div className="mt-2">
              <label className="inline-flex items-center">
                <input type="checkbox" className="w-4 h-4 border-0 focus:ring-0" checked />
                <span className="ml-2"><li key={id}>{title}</li></span>
              </label>
            </div>
